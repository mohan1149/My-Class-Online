...
export default class addExamClassComponent extends Component {
    constructor(props) {
        super(props);
        this.state = {
            userSyllabus: null,
                                ...
                                {this.state.userSyllabus.map((class_data, index) => {
                                    return (
                                        <ListItem
                                            ...
                                            rightElement={
                                                <TouchableOpacity
                                                    onPress={(e) => this.addEaxm(class_data.class_id, JSON.parse(class_data.subject).subject)}
                                                >
                                                    <Image
    ...
    addEaxm(cid, subject) {
        ...
        this.props.navigation.navigate('addEaxm', screen_data);
    }
}